"""
Você foi encarregado de comprar prendas de uma festa  junina e deve comprar o máximo 
de produtos que couberem em uma mochila, repetindo em no máximo 5 unidades por tipo 
de prenda. Implemente um algoritmo capaz de encontrar  o número e tipo das prendas, 
sabendo que a mochila tem o volume interno de 20L. Após encontrá-las, liste o número 
de itens por tipo de produto e o preço total da compra.
P.S.: Assuma que as prendas são líquidos, de maneira que seu volume possa ser somado 
sem levar em conta largura/altura/profundidade da mochila.

Entrada: 
produtos = {
    "pesca_peixe"       : {"volume": 0.2, "preço": 4},
    "estalinho"         : {"volume": 0.05, "preço": 1},
    "carrinho"          : {"volume": 2.00, "preço": 20},
    "molinha"           : {"volume": 0.5, "preço": 5},
    "coçador_de_costas" : {"volume": 1.5, "preço": 1},
    "bolinhas_de_sabao" : {"volume": 0.3, "preço": 0.5},
}
"""
