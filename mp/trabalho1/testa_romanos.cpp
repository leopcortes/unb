...
TEST_CASE("Numeros romanos - algarismos combinados <= 3 vezes", "[romanos]") {
    REQUIRE(romanos_para_decimal("I") == 1);
...
TEST_CASE("Numeros romanos - algarismos combinados += maior", "[romanos]") {
...
TEST_CASE("Numeros romanos - invalidos - outros algarismos", "[romanos]") {
...
TEST_CASE("Numeros romanos - combinacoes proibidas", "[romanos]") {
...
TEST_CASE("Numeros romanos - algarismos fora de alcance", "[romanos]") {
