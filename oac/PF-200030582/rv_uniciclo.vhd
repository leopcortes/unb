...
begin
  ...
  rom : rom_rv port map(pc_out(9 downto 2), rom_dataout);
  ...
  banco_reg : XREGS port map(aux_clk, reg_write, rs1, rs2, rd, data, ro1, ro2);
  ...
  ram : ram_rv port map(aux_clk, mem_write, saida_ula(11 downto 0), ro2, ram_dataout);
