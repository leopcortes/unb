...
architecture RTL of ulaRV_tb is
  component ulaRV is
...
begin
  ula_rv : ulaRV port map(A => A_in, B => B_in, Z => Z_out, opcode => opcode_in, zero => zero_out);
  ...
  process begin
    ...
    assert false report "Testes da ULA concluidos." severity note;
    wait for 1 ns;
