...
BLYNK_WRITE(V0){ // Terminal 1
  if(String(senhaWifi) == param.asStr()){ // Se senha for correta
...
BLYNK_WRITE(V2){ // Terminal 2
  ...
  if(String(senhaWifi) == senha_antiga){ // Se a senha_antiga estiver correta
    terminal2.println("Senha correta.");
    senhaWifi = senhas.substring(5,9); // Torna a senha_nova como a senha
