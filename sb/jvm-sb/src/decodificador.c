 ...
 *
 * Arquivo que contem funcao para decodificar uma instrucao
 * e apresentar os mnemonicos de cada instrucao no exibidor.
 */

#include "../includes/decodificador.h"

/**
 * @brief Funcao que inicializa um vetor de instrucoes que fornecem o mnemonico e quantidade de argumentos de cada instrucao
 * @param dec[] Recebe um vetor de estrutura decodificador - contem mnemonico e quantidade de argumentos de uma instrucao
 */
void inicializa_decodificador(decodificador dec[])
{
	...
	strcpy(dec[170].instrucao, "tableswitch"); // verificar a quantidade de bytes
	dec[170].bytes = 14;

	strcpy(dec[171].instrucao, "lookupswitch"); // verificar a quantidade de bytes
	dec[171].bytes = 10;
	...
	strcpy(dec[196].instrucao, "wide"); // verificar a quantidade de bytes
	dec[196].bytes = 3;
