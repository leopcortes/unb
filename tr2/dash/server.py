...
def manifest():
    return jsonify({
        "video": {
            "representations": [
                {"id": "360p", "bandwidth": 500, "url": "http://127.0.0.1:5000/video/360p"},
                {"id": "480p", "bandwidth": 1000, "url": "http://127.0.0.1:5000/video/480p"},
                {"id": "720p", "bandwidth": 2500, "url": "http://127.0.0.1:5000/video/720p"},
                {"id": "1080p", "bandwidth": 5000, "url": "http://127.0.0.1:5000/video/1080p"},
            ]
        }
    })
...
def video_segment(quality):
    ...
    file_map = {
        "360p": ("segments/360p_segment.mp4", 0.1),
        "480p": ("segments/480p_segment.mp4", 0.2),
        "720p": ("segments/720p_segment.mp4", 0.3),
        "1080p": ("segments/1080p_segment.mp4", 0.4),
    }
